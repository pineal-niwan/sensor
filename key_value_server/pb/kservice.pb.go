...
func (*MsgKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_kservice_1263616a26ecfc28, []int{0}
}
...
func (dst *MsgKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgKey.Merge(dst, src)
}
...
func (*MsgValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_kservice_1263616a26ecfc28, []int{1}
}
...
func (dst *MsgValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgValue.Merge(dst, src)
}
...
func (*MsgKeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_kservice_1263616a26ecfc28, []int{2}
}
...
func (dst *MsgKeyValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgKeyValue.Merge(dst, src)
}
...
func (*MsgKeyValueTimeout) Descriptor() ([]byte, []int) {
	return fileDescriptor_kservice_1263616a26ecfc28, []int{3}
}
...
func (dst *MsgKeyValueTimeout) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgKeyValueTimeout.Merge(dst, src)
}
...
func (*MsgKeyTimeout) Descriptor() ([]byte, []int) {
	return fileDescriptor_kservice_1263616a26ecfc28, []int{4}
}
...
func (dst *MsgKeyTimeout) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgKeyTimeout.Merge(dst, src)
}
...
// 长度
type MsgLen struct {
	HashLen              int32    `protobuf:"varint,1,opt,name=hashLen" json:"hashLen,omitempty"`
...
func (*MsgLen) Descriptor() ([]byte, []int) {
	return fileDescriptor_kservice_1263616a26ecfc28, []int{5}
}
...
func (dst *MsgLen) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgLen.Merge(dst, src)
}
...
func init() { proto.RegisterFile("kservice.proto", fileDescriptor_kservice_1263616a26ecfc28) }

var fileDescriptor_kservice_1263616a26ecfc28 = []byte{
